...
def get_args():
    parser = argparse.ArgumentParser('EEMo EEG tokenizer pre-training script', add_help=False)
...
def main(args):
    ...
    dataset_train_list, train_ch_names_list = utils.build_pretraining_dataset(datasets_train, time_window, stride_size=200, start_percentage=0, end_percentage=1)
    ...
    if args.disable_eval:
        ...
        val_dataset, _ = get_pretrain_dataset("A_depression_EEG", "val")
